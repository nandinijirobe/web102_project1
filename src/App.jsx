...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      {/* <h3>(ಭಾರತದ ಕರ್ನಾಟಕದಲ್ಲಿರುವ ಪ್ರಸಿದ್ಧ್ ೧೦ ಪ್ರವಾಸಿ ಸ್ಥಳಗಳು)</h3> */}
      ...
      {/* <h4>(ಕರ್ನಾಟಕಕ್ಕೆ ಭೇಟಿ ನೀಡುತ್ತೀರಾ? ಈ ಜನಪ್ರಿಯ ಪ್ರವಾಸಿ ತಾಣಗಳನ್ನು ಪರಿಶೀಲಿಸಿ! ಈ ರಾಜ್ಯವು ಸುಂದರವಾದ ಪಾರಂಪರಿಕ ತಾಣಗಳಿಂದ ಹಿಡಿದು ರಾಷ್ಟ್ರೀಯ ವನ್ಯಜೀವಿ ಉದ್ಯಾನವನಗಳವರೆಗೆ ಎಲ್ಲವನ್ನೂ ನೀಡುತ್ತದೆ!)</h4> */}
      <Calendar />
    </div>
  )
}
